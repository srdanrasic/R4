...
/*!
 ...
 @discussion When creating new shader, you have to provide a mapping dictionary for any attribute used in the shader. Keys are attribute names as they appear in shader source code and values are NSNumber objects created from R4VertexAttribute enum, e.g. @{ @"position_modelspace": @(R4VertexAttributePositionModelSpace) }
 
 @warning You should never instantiate R4Shader objects directly, rather R4ProgramManager should be used to create new shaders.
 */
