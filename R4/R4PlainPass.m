...
- (instancetype)init
{
  ...
  if (self) {
    ...
    self.vertexShader = [[R4ProgramManager shared] loadShaderNamed:@"vshPlainShader" type:R4ShaderTypeVertex attributeMapping:attribMap];
    self.fragmentShader = [[R4ProgramManager shared] loadShaderNamed:@"fshPlainShader" type:R4ShaderTypeFragment attributeMapping:nil];
    [self program];
  }
  return self;
}
